# Parte 2 – Estruturas condicionais (1 ponto extra)
...
# 4. Faça um Programa que verifique se uma letra digitada é "F" ou "M". Conforme a letra escrever: F - Feminino,
# M - Masculino, Sexo Inválido.
# 5. Faça um Programa que verifique se uma letra digitada é vogal ou consoante.
# 6. Faça um programa para a leitura de duas notas parciais de um aluno. O programa deve calcular a média
...
# o caso.
# 12. As Organizações Tabajara resolveram dar um aumento de salário aos seus colaboradores e lhe contraram
...
# 13. Faça um programa para o cálculo de uma folha de pagamento, sabendo que os descontos são do Imposto
...
# 15. Faça um programa que lê as duas notas parciais obtidas por um aluno numa disciplina ao longo de um
...
# 16. Faça um Programa que peça os 3 lados de um triângulo. O programa deverá informar se os valores podem
...
# 17. Faça um programa que calcule as raízes de uma equação do segundo grau, na forma ax2 + bx + c. O
...
# b. Se o delta calculado for negativo, a equação não possui raizes reais. Informe ao usuário e encerre
# o programa;
...
# o 12 = 1 dezena e 2 unidades Testar com: 326, 300, 100, 320, 310,305, 301, 101, 311, 111, 25, 20,
# 10, 21, 11, 1, 7 e 16
...
# 22. Faça um Programa para um caixa eletrônico. O programa deverá perguntar ao usuário a valor do saque e
...
# a. Exemplo 1: Para sacar a quantia de 256 reais, o programa fornece duas notas de 100, uma nota de
# 50, uma nota de 5 e uma nota de 1;
# b. Exemplo 2: Para sacar a quantia de 399 reais, o programa fornece três notas de 100, uma nota de
...
# tipo e quantidade de carne, preço total, tipo de pagamento, valor do desconto e valor a paga